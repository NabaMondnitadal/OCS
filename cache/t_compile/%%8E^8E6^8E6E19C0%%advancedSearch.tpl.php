<?php /* Smarty version 2.6.26, created on 2016-06-12 15:10:28
...
<tr valign="top">
	<td class="label"><label for="searchConference"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "search.withinConference"), $this);?>
</label></td>
	<td class="value"><select name="searchConference" id="searchConference" class="selectMenu"><?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['conferenceOptions'],'selected' => $this->_tpl_vars['searchConference']), $this);?>
</select></td>
</tr>
<?php endif; ?>
<tr valign="top">
...
<tr valign="top">
	<td class="label"><label for="title"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "paper.title"), $this);?>
</label></td>
...
<tr valign="top">
	<td class="label"><label for="supplementaryFiles"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "paper.suppFiles"), $this);?>
</label></td>
...
<tr valign="top">
	...
	<td class="value"><?php echo smarty_function_html_select_date(array('prefix' => 'dateTo','time' => $this->_tpl_vars['dateTo'],'all_extra' => "class=\"selectMenu\"",'year_empty' => "",'month_empty' => "",'day_empty' => "",'start_year' => ($this->_tpl_vars['startYear']),'end_year' => ($this->_tpl_vars['endYear'])), $this);?>
</td>
</tr>
<tr valign="top">
