<?php /* Smarty version 2.6.26, created on 2016-07-10 07:58:21
         compiled from registration/users.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'registration/users.tpl', 22, false),array('function', 'url', 'registration/users.tpl', 26, false),array('function', 'html_options_translate', 'registration/users.tpl', 28, false),array('function', 'sort_heading', 'registration/users.tpl', 44, false),array('function', 'icon', 'registration/users.tpl', 58, false),array('function', 'page_info', 'registration/users.tpl', 73, false),array('function', 'page_links', 'registration/users.tpl', 74, false),array('modifier', 'escape', 'registration/users.tpl', 35, false),array('modifier', 'concat', 'registration/users.tpl', 56, false),array('modifier', 'to_array', 'registration/users.tpl', 57, false),array('modifier', 'assign', 'registration/users.tpl', 57, false),array('modifier', 'truncate', 'registration/users.tpl', 58, false),array('block', 'iterate', 'registration/users.tpl', 50, false),)), $this); ?>
<?php echo ''; ?><?php if ($this->_tpl_vars['registrationId']): ?><?php echo ''; ?><?php $this->assign('pageTitle', "manager.registration.selectRegistrant"); ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php $this->assign('pageTitle', "manager.registration.select"); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<?php if ($this->_tpl_vars['registrationCreated']): ?>
<br/><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.registration.registrationCreatedSuccessfully"), $this);?>
<br/>
<?php endif; ?>

<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.registration.selectRegistrant.desc"), $this);?>
</p>
<form method="post" name="submit" action="<?php if ($this->_tpl_vars['registrationId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectRegistrant','registrationId' => $this->_tpl_vars['registrationId']), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectRegistrant','registrationId' => $this->_tpl_vars['registrationId']), $this);?>
<?php endif; ?>">
...
?><a href="<?php if ($this->_tpl_vars['registrationId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectRegistrant','searchInitial' => $this->_tpl_vars['letter'],'registrationId' => $this->_tpl_vars['registrationId']), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectRegistrant','searchInitial' => $this->_tpl_vars['letter']), $this);?>
<?php endif; ?>"><?php if ($this->_tpl_vars['letter'] == $this->_tpl_vars['searchInitial']): ?><strong><?php echo ((is_array($_tmp=$this->_tpl_vars['letter'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<?php endif; ?></a> <?php endforeach; endif; unset($_from); ?><a href="<?php if ($this->_tpl_vars['registrationId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectRegistrant','registrationId' => $this->_tpl_vars['registrationId']), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectRegistrant'), $this);?>
<?php endif; ?>"><?php if ($this->_tpl_vars['searchInitial'] == ''): ?><strong><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.all"), $this);?>
...
<tr class="heading" valign="bottom">
	...
	<td width="35%"><?php echo $this->_plugins['function']['sort_heading'][0][0]->smartySortHeading(array('key' => "user.name",'sort' => 'name'), $this);?>
</td>
...
<tr valign="top">
	<td><?php if ($this->_tpl_vars['isSchedConfManager']): ?><a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'userProfile','path' => $this->_tpl_vars['userid']), $this);?>
"><?php endif; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getUsername())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php if ($this->_tpl_vars['isSchedConfManager']): ?></a><?php endif; ?></td>
...
&nbsp;<?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => $this->_tpl_vars['url']), $this);?>
	...
	<td align="right" class="nowrap">
		<a href="<?php if ($this->_tpl_vars['registrationId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editRegistration','path' => $this->_tpl_vars['registrationId'],'userId' => $this->_tpl_vars['user']->getId()), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createRegistration','userId' => $this->_tpl_vars['user']->getId()), $this);?>
<?php endif; ?>" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.registration.enroll"), $this);?>
</a>
	</td>
</tr>
