<?php /* Smarty version 2.6.26, created on 2016-06-12 15:43:06
         compiled from trackDirector/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'trackDirector/index.tpl', 13, false),array('function', 'translate', 'trackDirector/index.tpl', 31, false),array('function', 'html_options', 'trackDirector/index.tpl', 38, false),array('function', 'html_options_translate', 'trackDirector/index.tpl', 46, false),array('modifier', 'assign', 'trackDirector/index.tpl', 13, false),array('modifier', 'escape', 'trackDirector/index.tpl', 38, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "common.queue.long.".($this->_tpl_vars['pageToDisplay'])); ?><?php echo ''; ?><?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'trackDirector'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'currentUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'currentUrl'));?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsInReview"), $this);?>
	...
	<li<?php if (( $this->_tpl_vars['pageToDisplay'] == 'submissionsAccepted' )): ?> class="current"<?php endif; ?>><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => 'submissionsAccepted'), $this);?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "trackDirector/".($this->_tpl_vars['pageToDisplay']).".tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
