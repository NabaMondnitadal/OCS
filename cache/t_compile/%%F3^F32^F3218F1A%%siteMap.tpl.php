<?php /* Smarty version 2.6.26, created on 2016-07-10 08:14:53
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.home"), $this);?>
	...
	<?php if ($this->_tpl_vars['isUserLoggedIn']): ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('conference' => 'index','page' => 'user'), $this);?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.about"), $this);?>
				...
				<li>
					<?php if ($this->_tpl_vars['isUserLoggedIn']): ?>
						<ul class="plain">
							<?php $this->assign('currentConferenceId', $this->_tpl_vars['currentConference']->getId()); ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.search"), $this);?>
					...
					<ul class="plain">
						<li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('conference' => $this->_tpl_vars['currentConference']->getPath(),'page' => 'search','op' => 'authors'), $this);?>
