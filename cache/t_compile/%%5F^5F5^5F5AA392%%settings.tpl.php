<?php /* Smarty version 2.6.26, created on 2016-07-07 09:04:57
...
" size="40" maxlength="255" class="textField" />
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'redirect','key' => "admin.settings.conferenceRedirect"), $this);?>
</td>
		<td colspan="2" class="value">
			<select name="redirect" id="redirect" size="1" class="selectMenu">
				<option value=""><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "admin.settings.noConferenceRedirect"), $this);?>
</option>
	...
	<tr valign="top">
		<td>&nbsp;</td>
		<td colspan="2" class="value"><span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "admin.settings.conferenceRedirectInstructions"), $this);?>
</span></td>
	</tr>
	<tr valign="top">
...
" class="button" onclick="document.location.href='<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'admin'), $this);?>
'" /></p>
