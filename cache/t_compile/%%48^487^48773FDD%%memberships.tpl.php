...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.groups.editTitle"), $this);?>
	...
	<li class="current"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'groupMembership','path' => $this->_tpl_vars['group']->getId(),'clearPageContext' => 1), $this);?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'memberships','item' => 'membership')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<tr class="data" id="membership-<?php echo $this->_tpl_vars['membership']->getUserId(); ?>
" valign="top">
...
<?php else: ?>
	<tr>
		...
		<td align="right"><?php echo $this->_plugins['function']['page_links'][0][0]->smartyPageLinks(array('anchor' => 'memberships','name' => 'memberships','iterator' => $this->_tpl_vars['memberships']), $this);?>
</td>
	</tr>
<?php endif; ?>
</table>
