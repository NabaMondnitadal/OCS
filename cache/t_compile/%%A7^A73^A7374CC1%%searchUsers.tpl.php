<?php /* Smarty version 2.6.26, created on 2016-06-12 15:29:04
         compiled from manager/people/searchUsers.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/people/searchUsers.tpl', 17, false),array('function', 'translate', 'manager/people/searchUsers.tpl', 26, false),array('function', 'html_options_translate', 'manager/people/searchUsers.tpl', 57, false),array('function', 'sort_heading', 'manager/people/searchUsers.tpl', 108, false),array('function', 'icon', 'manager/people/searchUsers.tpl', 124, false),array('function', 'page_info', 'manager/people/searchUsers.tpl', 150, false),array('function', 'page_links', 'manager/people/searchUsers.tpl', 151, false),array('modifier', 'escape', 'manager/people/searchUsers.tpl', 26, false),array('modifier', 'concat', 'manager/people/searchUsers.tpl', 122, false),array('modifier', 'to_array', 'manager/people/searchUsers.tpl', 123, false),array('modifier', 'assign', 'manager/people/searchUsers.tpl', 123, false),array('modifier', 'truncate', 'manager/people/searchUsers.tpl', 124, false),array('block', 'iterate', 'manager/people/searchUsers.tpl', 114, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "manager.people.enrollExistingUser"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<form name="enroll" action="<?php if ($this->_tpl_vars['roleId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enroll','path' => $this->_tpl_vars['roleId']), $this);?>
...
<?php if (! $this->_tpl_vars['roleId']): ?>
 ...
 <select name="roleId" size="1"  class="selectMenu">
		...
		<?php if ($this->_tpl_vars['isConferenceManagement']): ?>
			<option value="<?php echo @ROLE_ID_CONFERENCE_MANAGER; ?>
