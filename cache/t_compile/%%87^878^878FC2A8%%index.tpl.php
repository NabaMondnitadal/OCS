<?php /* Smarty version 2.6.26, created on 2016-06-12 15:42:09
         compiled from about/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'about/index.tpl', 18, false),array('function', 'url', 'about/index.tpl', 21, false),array('function', 'call_hook', 'about/index.tpl', 32, false),array('block', 'iterate', 'about/index.tpl', 20, false),array('modifier', 'escape', 'about/index.tpl', 44, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "about.aboutTheConference"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<ul class="plain">
	<?php if ($this->_tpl_vars['showAboutSchedConf'] && $this->_tpl_vars['currentSchedConf']->getLocalizedSetting('reviewPolicy') != ''): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'peerReviewProcess'), $this);?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.archiveAccessPolicy"), $this);?>
	...
	<?php if ($this->_tpl_vars['conferenceSettings']['enableDelayedOpenAccess'] || $this->_tpl_vars['conferenceSettings']['enableAuthorSelfArchive']): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editorialPolicies','anchor' => 'openAccessPolicy'), $this);?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.onlineSubmissions"), $this);?>
	...
	<?php if ($this->_tpl_vars['currentSchedConf'] && $this->_tpl_vars['currentSchedConf']->getLocalizedSetting('authorGuidelines') != ''): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submissions','anchor' => 'authorGuidelines'), $this);?>
