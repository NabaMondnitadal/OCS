<?php /* Smarty version 2.6.26, created on 2016-06-12 16:06:21
         compiled from about/submissions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'about/submissions.tpl', 17, false),array('function', 'translate', 'about/submissions.tpl', 17, false),array('modifier', 'escape', 'about/submissions.tpl', 26, false),array('modifier', 'nl2br', 'about/submissions.tpl', 41, false),)), $this); ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.onlineSubmissions"), $this);?>
	...
	<?php if ($this->_tpl_vars['authorGuidelines'] != ''): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'submissions','anchor' => 'authorGuidelines'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.authorGuidelines"), $this);?>
</a></li><?php endif; ?>
	<?php if ($this->_tpl_vars['copyrightNotice'] != ''): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'submissions','anchor' => 'copyrightNotice'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.copyrightNotice"), $this);?>
</a></li><?php endif; ?>
	<?php if ($this->_tpl_vars['privacyStatement'] != ''): ?><li>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'about','op' => 'submissions','anchor' => 'privacyStatement'), $this);?>
...
<?php if ($this->_tpl_vars['submissionChecklist']): ?>
	...
	<div id="submissionPreparationChecklist">
		<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.submissionPreparationChecklist"), $this);?>
</h3>
	<ol>
...
<?php if ($this->_tpl_vars['copyrightNotice'] != ''): ?>
	...
	<p><?php echo ((is_array($_tmp=$this->_tpl_vars['copyrightNotice'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</p>
	</div>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['privacyStatement'] != ''): ?>
	<div id="privacyStatement">
		<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "about.privacyStatement"), $this);?>
</h3>
	<div class="separator">&nbsp;</div>
