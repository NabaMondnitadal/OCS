<?php /* Smarty version 2.6.26, created on 2016-06-12 15:43:06
         compiled from trackDirector/submissionsInReview.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sort_search', 'trackDirector/submissionsInReview.tpl', 15, false),array('function', 'translate', 'trackDirector/submissionsInReview.tpl', 22, false),array('function', 'url', 'trackDirector/submissionsInReview.tpl', 51, false),array('function', 'page_info', 'trackDirector/submissionsInReview.tpl', 104, false),array('function', 'page_links', 'trackDirector/submissionsInReview.tpl', 105, false),array('block', 'iterate', 'trackDirector/submissionsInReview.tpl', 36, false),array('modifier', 'date_format', 'trackDirector/submissionsInReview.tpl', 41, false),array('modifier', 'escape', 'trackDirector/submissionsInReview.tpl', 42, false),array('modifier', 'truncate', 'trackDirector/submissionsInReview.tpl', 50, false),array('modifier', 'to_array', 'trackDirector/submissionsInReview.tpl', 51, false),array('modifier', 'strip_tags', 'trackDirector/submissionsInReview.tpl', 51, false),array('modifier', 'default', 'trackDirector/submissionsInReview.tpl', 51, false),)), $this); ?>
<div id="submissions">
...
" class="action"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 40, "...") : $this->_plugins['modifier']['truncate'][0][0]->smartyTruncate($_tmp, 40, "...")))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
</a></td>
		<td>
		<table width="100%">
...
<?php else: ?>
	<tr>
		<td colspan="6" align="left"><?php echo $this->_plugins['function']['page_info'][0][0]->smartyPageInfo(array('iterator' => $this->_tpl_vars['submissions']), $this);?>
</td>
