<?php /* Smarty version 2.6.26, created on 2016-06-12 15:49:45
         compiled from schedConf/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'nl2br', 'schedConf/index.tpl', 22, false),array('modifier', 'date_format', 'schedConf/index.tpl', 24, false),array('modifier', 'escape', 'schedConf/index.tpl', 49, false),array('function', 'translate', 'schedConf/index.tpl', 36, false),array('function', 'url', 'schedConf/index.tpl', 40, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['schedConf']->getSetting('startDate')): ?>
	<?php $this->assign('startDate', ((is_array($_tmp=$this->_tpl_vars['schedConf']->getSetting('startDate'))) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatLong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatLong']))); ?>
	<?php $this->assign('endDate', ((is_array($_tmp=$this->_tpl_vars['schedConf']->getSetting('endDate'))) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatLong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatLong']))); ?>
	<h2><?php echo $this->_tpl_vars['startDate']; ?>
<?php if ($this->_tpl_vars['startDate'] != $this->_tpl_vars['endDate']): ?> &ndash; <?php echo $this->_tpl_vars['endDate']; ?>
<?php endif; ?></h2>
<?php endif; ?>
