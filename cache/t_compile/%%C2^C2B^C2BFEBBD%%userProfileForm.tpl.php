<?php /* Smarty version 2.6.26, created on 2016-06-12 15:15:41
         compiled from manager/people/userProfileForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/people/userProfileForm.tpl', 12, false),array('function', 'translate', 'manager/people/userProfileForm.tpl', 54, false),array('function', 'fieldLabel', 'manager/people/userProfileForm.tpl', 88, false),array('function', 'form_language_chooser', 'manager/people/userProfileForm.tpl', 91, false),array('function', 'html_options_translate', 'manager/people/userProfileForm.tpl', 116, false),array('function', 'html_options', 'manager/people/userProfileForm.tpl', 154, false),array('modifier', 'assign', 'manager/people/userProfileForm.tpl', 12, false),array('modifier', 'escape', 'manager/people/userProfileForm.tpl', 78, false),)), $this); ?>
<?php echo ''; ?><?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'people','path' => 'all'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'currentUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'currentUrl'));?><?php echo ''; ?><?php if ($this->_tpl_vars['userId']): ?><?php echo ''; ?><?php $this->assign('pageTitle', "manager.people.editProfile"); ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php $this->assign('pageTitle', "manager.people.createUser"); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
" size="5" maxlength="5" class="textField" />&nbsp;&nbsp;<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.initialsExample"), $this);?>
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('suppressId' => 'true','name' => 'username','required' => 'true','key' => "user.username"), $this);?>
</td>
		<td class="value">
...
" onclick="generateUsername()" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.account.usernameRestriction"), $this);?>
</span>
		</td>
	</tr>
	<?php else: ?>
	<tr valign="top">
		...
		<td class="value" id="username"><strong><?php echo ((is_array($_tmp=$this->_tpl_vars['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</strong></td>
	</tr>
	<?php endif; ?>
...
" size="20" maxlength="32" class="textField" />
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.account.passwordLengthRestriction",'length' => $this->_tpl_vars['minPasswordLength']), $this);?>
</span>
		</td>
	</tr>
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'password2','required' => $this->_tpl_vars['passwordRequired'],'key' => "user.account.repeatPassword"), $this);?>
</td>
...
" size="20" maxlength="32" class="textField" /></td>
	...
	<tr valign="top">
		<td>&nbsp;</td>
		<td class="value"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.account.passwordLengthRestriction",'length' => $this->_tpl_vars['minPasswordLength']), $this);?>
...
]" id="interests" rows="3" cols="40" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['interests'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></td>
	</tr>
	<tr valign="top">
